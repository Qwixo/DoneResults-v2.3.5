        ...
        <div className="features-grid">
          <div className="feature-card-wrapper">
            <div className="feature-card">
              ...
              <p>We research each prospect and craft messages that speak directly to their specific situation, not just "Hi {FirstName}" templates.</p>
            </div>
          ...
          <div className="feature-card-wrapper">
            <div className="feature-card">
              <div className="feature-icon-wrapper">
                <img src="/images<boltArtifact id="timeline-implementation" title="Timeline Component Implementation">
<boltAction type="file" filePath="src/components/Differentiators.tsx">/icon-personalization.svg" alt="Personalization" />
              </div>
              <h3>True Personalization</h3>
              <p>We research each prospect and craft messages that speak directly to their specific situation, not just "Hi {FirstName}" templates.</p>
            </div>
